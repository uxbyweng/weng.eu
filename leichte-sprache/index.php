...
<body>
    ...
    <section class="px-3 px-md-0 py-5">
        <div class="container">
            ...
            <ul>
                <?php if ($sprache === 'en'): ?>
                    <li><h3>Making websites easy to use and clearly structured</h3></li>
                    <li><h3>Programming web applications</h3></li>
                    <li><h3>Making websites accessible and faster to load</h3></li>
                    <li><h3>Optimizing websites for search engines like Google</h3></li>
                    <li><h3>Taking and editing photos</h3></li>
                <?php else: ?>
                    <li><h3>Webseiten leicht bedienbar machen und übersichtlich gestalten </h3></li>
                    <li><h3>Programmierung von Webanwendungen</h3></li>
                    <li><h3>Webseiten barrierefrei machen und schneller laden lassen</h3></li>
                    <li><h3>Webseiten für Suchmaschinen wie z.B. Google optimieren</h3></li>
                    <li><h3>Fotos machen und bearbeiten</h3></li>
                <?php endif; ?>
            </ul>
        </div>
    </section>
