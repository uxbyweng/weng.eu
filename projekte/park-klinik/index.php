            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-7 order-3 order-md-2">
                    <p class="fs-24 lh-1-3 my-3">
                        <em>Seit 2017 verantwortlich für Konzeption, Design und die komplette technische Umsetzung auf Basis von Bootstrap 5.
                            Fokus: Barrierearme UX, Performance, saubere SEO-Grundlagen und effiziente Pflege mit PHP-Includes.</em>
                    </p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8 order-1 pe-5">
                    ...
                    <article>
                        ...
                        <figcaption class="text-muted small mt-2">
                            Beispielunterseite mit responsiven <code>&lt;picture&gt;</code>-Assets, Lazy-Loading und klarer Hierarchie
                        </figcaption>
                    </article>
                ...
                <aside class="col-12 col-md-4 order-2 pt-5 pt-md-0 pe-5">
                    <section class="pb-3 border-bottom">
                        ...
                        <p>
                            Für die <em>Park-Klinik Birkenwerder</em> übernehme ich seit 2017 die ganzheitliche Betreuung:
                            UX-Konzeption, Design, Frontend & PHP-Integration, Medienaufbereitung, technische SEO sowie laufende Optimierungen.
                            Ziel ist eine robuste, schnelle Website mit klarer Patient:innenführung.
                        </p>
                    </section>
                    ...
                    <section class="py-3 border-bottom">
                        ...
                        <p class="text-muted small">
                            Auszug aus dem Code: Preloads, OG/Twitter-Meta, strukturierte Daten, Cookie-Consent, YouTube/Vimeo-Embeds.
                        </p>
                    </section>
                    ...
                    <section class="py-3 border-bottom">
                        ...
                        <p>
                            UX-Konzeption & IA, Responsive Webdesign, Frontend-Entwicklung, PHP-Includes,
                            Performance-Tuning, SEO-Setup, Barrierearmut, Bild/Video-Produktion, Wartung & Weiterentwicklung
                        </p>
                    </section>
                    ...
                    <section class="py-3 border-bottom">
                        <h2 class="fs-20 text-uppercase"><strong>Beispiele (Auszug)</strong></h2>
                        <ul class="mb-0">
                            <li><a href="https://www.park-klinik-birkenwerder.de/gesicht/" rel="nofollow">Gesicht</a></li>
                            <li><a href="https://www.park-klinik-birkenwerder.de/brust/" rel="nofollow">Brust</a></li>
                            <li><a href="https://www.park-klinik-birkenwerder.de/koerper/lipoedem/" rel="nofollow">Lipödem</a></li>
                            <li><a href="https://www.park-klinik-birkenwerder.de/news/" rel="nofollow">News</a></li>
                        </ul>
                    </section>

                    <section class="py-3">
                        <h2 class="fs-20 text-uppercase"><strong>Zeitraum</strong></h2>
                        <p>2017 – heute (laufend)</p>
                    </section>
                </aside>
