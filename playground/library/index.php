                ...
                <div class="row">
                    <div class="col-lg-9">
                        <section class="py-5 border-bottom" id="section-typography">
                            <div class="container">
                                <h2 class="font-accent mt-0 mb-5">Typography</h2>
                                <div class="row g-4">
                                    <div class="col-12">
                        ...
                        <section class="py-5 border-bottom" id="section-buttons">
                            <div class="container">
                                <h2 class="font-accent mt-0 mb-5">Buttons</h2>
                        ...
                        <section class="py-5 border-bottom" id="section-colors">
                            <div class="container">
                                <h2 class="font-accent mt-0 mb-5">Colors</h2>
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        <div class="bg-accent" style="width:100px; height:100px; background-color:#d72b00; border-radius:100px;"></div>
                                        <p>
                                            <strong>Primary/Accent</strong><br>
                                            .bg-accent<br>
                                            .font-accent<br>
                                            #d72b00
                                        </p>
                        ...
                        <section class="py-5 border-bottom" id="section-icons">
                            <div class="container">
                                <h2 class="font-accent mt-0 mb-4">Icons</h2>
                        ...
                        <section class="py-5 border-bottom" id="section-links">
                            <div class="container">
                                <h2 class="font-accent mt-0 mb-4">Links</h2>
                                <p><code>p</code> uses Noto | <code>font-size:</code> clamp(1rem, 1.5vw, 1.2rem)</p>
                                <p>Lorem ipsum dolor sit amet, <a href="#">dies ist ein Link</a> im Fließtext.</p>
                            </div>
                        </section>
