...
<html lang="<?= $lang === 'en' ? 'en' : 'de' ?>" data-bs-theme="<?= e($theme) ?>">
  <head>
    ...
    <noscript><link rel="stylesheet" href="/assets/vendor/bootstrap/bootstrap-icons/bootstrap-icons.min.css?v=<?= $iconsV ?>"></noscript>
    <link rel="preload" href="/assets/css/styles.css?v=<?= $cssV ?>" as="style" onload="this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="/assets/css/styles.css?v=<?= $cssV ?>"></noscript>
