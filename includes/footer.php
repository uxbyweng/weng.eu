            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                <div class="text-center mt-3 mt-md-0">
                    <p class="footer-color fs-22 fs-18-md">
                        ...
                        <?php else: ?>
                            <a href="/datenschutz/#no-tracking-de" class="px-2">
                                Kein&nbsp;Tracking
                            </a>
                        <?php endif; ?> |
                        <?php if ($sprache === 'en'): ?>
                            <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" class="px-2" title="Creative Commons Attribution-ShareAlike 4.0 International" rel="nofollow noopener">
                                <span class="nobr">CC&nbsp;BY-SA&nbsp;4.0</span>
                            </a>
                        <?php else: ?>
                            <a href="https://creativecommons.org/licenses/by-sa/4.0/deed.de" target="_blank" class="px-2" title="Creative Commons Namensnennung-Share Alike 4.0 International" rel="nofollow noopener">
                                <span class="nobr">CC&nbsp;BY-SA&nbsp;4.0</span>
                            </a>
                        <?php endif; ?>
                    </p>
